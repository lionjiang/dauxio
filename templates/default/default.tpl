...
<body>
    ...
    <!-- Homepage -->
        <div class="navbar navbar-fixed-top hidden-print">
            <div class="container">
                ...
                <p class="navbar-text pull-right">Generated by <a href="http://lionjiang.github.io/dauxio">Dauxio</a></p>
            </div>
        </div>
        <?php if ($params['repo']) { ?>
    ...
    <?php } else { ?>
        <!-- Docs -->
        <?php if ($params['repo']) { ?>
            <a href="https://github.com/<?php echo $params['repo']; ?>" target="_blank" id="github-ribbon" class="hidden-print"><img src="<?php echo $base_url; ?>img/forkme_right_darkblue_121621.png" alt="Fork me on GitHub"></a>
        <?php } ?>
